            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {STATS.map((stat, i) => (
                <div key={i} className="text-center group">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-red-600/10 rounded-xl flex items-center justify-center mx-auto mb-4 border border-red-600/20 group-hover:scale-110 transition-transform">
